...
const clientScreens: Record<ClientTab, React.ComponentType> = {
...
const masterScreens: Record<MasterTab, React.ComponentType> = {
...
export function AppLayout() {
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      <div className="orb" style={{ bottom: '5%', left: '-15%', width: '280px', height: '280px', background: 'radial-gradient(circle, rgba(201,169,110,0.2) 0%, transparent 70%)' }} />
      <div className="perspective-grid absolute inset-0 pointer-events-none z-0" />
